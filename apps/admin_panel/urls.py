...
urlpatterns = [
    ...
    path("api-keys/", views.api_keys_list, name="api_keys"),
    ...
    path("api-keys/<int:pk>/toggle/", views.api_key_toggle, name="api_key_toggle"),
    path("api-keys/<int:pk>/delete/", views.api_key_delete, name="api_key_delete"),
    path("custom-endpoints/", views.custom_endpoints_list, name="custom_endpoints"),
    path("custom-endpoints/new/", views.custom_endpoint_edit, name="custom_endpoint_create"),
    path("custom-endpoints/<int:pk>/edit/", views.custom_endpoint_edit, name="custom_endpoint_edit"),
    path("custom-endpoints/<int:pk>/delete/", views.custom_endpoint_delete, name="custom_endpoint_delete"),
